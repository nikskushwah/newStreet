...
urlpatterns = patterns('',
        ...
        url(r'^newstreet/$' , views.news, name = 'newstreet'),
	url(r'^newstreet/gps-on' , views.gps_news, name = 'gps'),
	url(r'^newstreet/gps-off',views.news, name = 'newstreet'),
    url(r'^newstreet/newstreet.html',views.news,name='newstreet'),
